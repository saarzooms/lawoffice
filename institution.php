 ...
 <div id="tpa_send" style="margin-top:0px;" class="mainbox col-md-12">                    
     <div class="panel panel-primary" >
       <div class="panel-heading" style="height:60px;">
			...
			<form id="institution_form" method="post">
           					<div class="col-md-12">
							<div class="col-md-4">
								<label for="name">Institution Name:</label>
								<div class="form-group">
									<input type="text" class="form-control input-sm" id="name" name="name" placeholder="Enter Institution Name">
								</div>
							</div>
							<div class="col-md-4">
								<label for="number">Institution Number:</label>
								<div class="form-group">
												
										<input type="text" class="form-control input-sm" id="number" name="number" placeholder="Enter Institution Number">
								</div>
							</div>
							<div class="col-md-4">
